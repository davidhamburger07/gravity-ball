...
- **Unlocking** — chapter 1 is a strict chain, because those levels are short enough to clear in a row and the chain is what teaches the verb. From chapter 2 on, a level opens on **total stars**: it asks for ~67% of the stars available from everything before it, minus a 4-star cushion. Stated as skill, that is an average of 2 stars out of 3 — competent play flows straight through, and the cushion absorbs one or two levels you could not beat. Skip three and the campaign asks you to go back; three-star play buys far more latitude. A gate is a *fraction* of the pool rather than a flat count on purpose: a flat count scaled to level index was cleared outright by three-starring chapter 1, which opened the whole game at once. Locked tiles show the stars still needed, and stars can come from replaying anything for a better rating.
